...
def run_programs_for_duration(duration):
    ...
    program1 = ["python", "/home/elpco/Desktop/Magnetic_Map_Acquisition_System/mag_ga/ins_aq.py", str(duration)]  # 将duration作为字符串传递
    program2 = ["python", "/home/elpco/Desktop/Magnetic_Map_Acquisition_System/mag_ga/mag_aq.py", str(duration)]  # 将duration作为字符串传递
